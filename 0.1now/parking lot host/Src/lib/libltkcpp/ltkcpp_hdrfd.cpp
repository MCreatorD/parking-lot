...
CFieldDescriptor
g_fdMessageHeader_SN =
{
    CFieldDescriptor::FT_U64,
...
CFieldDescriptor
g_fdParameterHeader_Type =
{
    CFieldDescriptor::FT_U16,
    CFieldDescriptor::FMT_NORMAL,
    "ParameterHeader.Type",
    NULL
};

CFieldDescriptor
g_fdParameterHeader_Length =
{
    CFieldDescriptor::FT_U16,
    CFieldDescriptor::FMT_NORMAL,
    "ParameterHeader.Length",
    NULL
};
