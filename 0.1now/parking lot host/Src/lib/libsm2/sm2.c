...
int sm3_e(unsigned char *xa, int xa_len, unsigned char *ya, int ya_len, unsigned char *msg, int msg_len, unsigned char *e)
{
/*
...
//		memcpy(buf, userid, userid_len);
	memcpy(buf, sm2_par_dig, 128);

	memset(buf+128, 0, 64);
	memcpy(buf+128+32-xa_len, xa, 32);
	memcpy(buf+128+32+32-ya_len, ya, 32);
