...
extern u8  flash_Dev_ok;     //芯片正常


#define EN25Q256_SPIx_CS_PIN                   GPIO_Pin_12
#define EN25Q256_SPIx_CS_GPIO_PORT             GPIOC
#define EN25Q256_SPIx_CS_GPIO_CLK              RCC_AHB1Periph_GPIOC
