...
#ifndef __LTKCPP_BASE_H__
#define __LTKCPP_BASE_H__
 ...
 */
//=======================================================//
extern CFieldDescriptor		g_fdMessageHeader_SN;
extern CFieldDescriptor		g_fdMessageHeader_Ver;
...
//========================================================//
extern CFieldDescriptor     g_fdParameterHeader_Type;
extern CFieldDescriptor     g_fdParameterHeader_Length;
//========================================================//
...
class CElement
{
  public:
	...
	//std::list<int> m_listAllSubParameters;
