...
//#define RX485USART5
	...
	#define RS485_RX_EN_PIN                 GPIO_Pin_6             
	#define RS485_RX_EN_CLK                 RCC_AHB1Periph_GPIOC    
	
	#define RS485_TX_EN_Port			          GPIOC
	#define RS485_TX_EN_PIN                 GPIO_Pin_8
	#define RS485_TX_EN_CLK                 RCC_AHB1Periph_GPIOC
	//初始化函数
	...
	#define RS485_TX_L             GPIO_ResetBits(RS485_TX_EN_Port , RS485_TX_EN_PIN) 	//SR PB4	 
	 ...
	 extern "C" {
	#endif
	#define RX485_USART_RX_LEN 256
	#define RX485_USART_TX_LEN 5000
